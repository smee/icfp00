...
%%%% Front
 {n 1 eqi
   ...
   seed size n self center apply /seed union
...
% render front view
{
10.0 rotatey -30.0 rotatex
} /aov

0 1.0 1 siep siep apply /seed aov apply
"siep1.ppm" doit apply


seed 1.0 2 siep siep apply /seed aov apply
"siep2.ppm" doit apply

seed 1.0 3 siep siep apply /seed
aov apply
"siep3.ppm" doit apply

seed 1.0 4 siep siep apply /seed
aov apply
"siep4.ppm" doit apply


%seed 1.0 5 siep siep apply /seed
%aov apply
%"siep5.ppm" doit apply
